...
class privicyController extends AdminController
{
    /**
    ...
    {
        $show = new Show(Privecy::findOrFail($id));
   ...
   protected function form()
{
    ...
    $form->saved(function(Form $form){
        ...
        return redirect('/admin/privecypage/'.$form->model()->id.'/edit');
    });
