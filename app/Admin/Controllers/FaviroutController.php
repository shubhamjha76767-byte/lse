...
class FaviroutController extends AdminController
{
    /**
    ...
    {
        $show = new Show(Favirout::findOrFail($id));
   ...
   protected function form()
{
    ...
    $form->saved(function(Form $form){
        ...
        return redirect('/admin/fav/'.$form->model()->id.'/edit');
    });
