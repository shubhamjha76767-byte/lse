...
class CastingController extends AdminController
{
    /**
    ...
    {
        $show = new Show(Casting::findOrFail($id));
   ...
   protected function form()
{
    ...
    $form->saved(function(Form $form){
        ...
        return redirect('/admin/casting/'.$form->model()->id.'/edit');
    });
