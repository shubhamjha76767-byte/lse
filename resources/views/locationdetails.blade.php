...
@section('meta_title', $location->html_title ?? 'Location - Models of Mayfair')
@section('meta_description', $location->meta_description ?? 'Learn more Location Models of Mayfair.')
@section('meta_keywords', $location->meta_keywords ?? 'models, Location, fashion')
